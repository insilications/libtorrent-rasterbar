...
Source0  : https://github.com/arvidn/libtorrent/releases/download/libtorrent-1_2_1/libtorrent-rasterbar-1.2.1.tar.gz
Summary  : A C++ BitTorrent library that aims to be a good alternative to all the other implementations around
...
%prep
%setup -q -n libtorrent-rasterbar-1.2.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1557756184
...
cp LICENSE %{buildroot}/usr/share/package-licenses/libtorrent-rasterbar/LICENSE
%make_install
...
/usr/share/package-licenses/libtorrent-rasterbar/LICENSE
